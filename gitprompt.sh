...
export PS1="\[\033[01;34m\]\d \t\[\033[00m\] \[\033[01;32m\]\u@\h\n\[\033[00m\]\[\033[01;34m\]\w\[\033[00m\]> \[$(tput sgr0)\]"
export PS1="\$(ExitStatus)$BLUE\d \t$RESET \n$GREEN\u$RESET @ $GREEN\h$RESET: $YELLOW\w$RESET\n\$(GitStatus)\$ "
export PS1="\$(ExitStatus)$BOLD_BLUE\d \t$RESET \n$BOLD_GREEN\u$RESET@$BOLD_GREEN\h$RESET: $BOLD_YELLOW\w$RESET\n\$(GitStatus)\$ "
